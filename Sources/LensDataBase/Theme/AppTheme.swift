import Foundation
    ...
    // MARK: - Non-SwiftUI Theme Constants
    ...
    public enum AppTheme {
        ...
        public enum CornerRadius {
            ...
            public static let round: Double = 50
        }

        // MARK: - Color Values (as hex strings)

        public enum ColorValues {
            public static let backgroundPrimary = "#181B25"
            public static let backgroundSecondary = "#222539"
            public static let backgroundTertiary = "#171717"

            public static let textPrimary = "#FFFFFF"
            public static let textSecondary = "#B0B0B0"
            public static let textTertiary = "#B3FFFFFF"

            public static let accent = "#00FF00"
            public static let accentSecondary = "#800080"
            public static let warning = "#FFA500"
            public static let error = "#FF0000"
        }
    }
