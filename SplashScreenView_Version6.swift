...
struct SplashScreenView: View {
    ...
    private func createAuraEffect() -> some View {
        Circle()
            .fill(
                RadialGradient(
                    gradient: Gradient(colors: [
    ...
    private func createLogoIcon() -> some View {
    ...
    private func createSubtitleText() -> some View {
    ...
    private func createLoadingContent() -> some View {
        Group {
    ...
    private func createDeveloperCredit() -> some View {
    ...
    private func handleLoadingStateChange(_ newState: DataLoadingState) {
...
/// Reusable glass card component with modern design
